...
export const PriceListPage: FC = () => {
  ...
  const [uploadedDocs, setUploadedDocs] = useState<UploadedPriceDoc[]>(() => {
    try {
      const saved = localStorage.getItem('varun_uploaded_price_docs') || localStorage.getItem('dheeksha_uploaded_price_docs');
  ...
  const saveDocsList = (docs: UploadedPriceDoc[]) => {
    ...
    try {
      localStorage.setItem('varun_uploaded_price_docs', JSON.stringify(docs));
  ...
  const handleDownloadTemplate = () => {
    ...
    const compName = storeSettings.companyName || 'Varun Trade';
      ...
      <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', mb: 2, flexWrap: 'wrap', gap: 1.5 }}>
        ...
        <Button
          ...
          sx={{
            ...
            color: showUploadZone ? '#FFFFFF' : '#92400E',
            borderColor: '#FDE68A',
            fontWeight: 700,
            fontSize: '13px',
            textTransform: 'none',
            ...
            '&:hover': {
              backgroundColor: showUploadZone ? '#B91C1C' : '#FFFBEB',
              borderColor: '#F59E0B',
            },
          }}
        >
